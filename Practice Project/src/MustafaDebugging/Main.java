            ...
            if(options==j){
                switch (options){
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                    	int ind=searchExpenses(expenses);
                        if(ind==-1)
                        {
                        	System.out.println("The entered expense not found!");
                        }
                        else
                        {
                        	System.out.println("Entered expense is found at: "+ind+" position");
                        }
                        optionsSelection(expenses);
                        break;
                    case 6:
